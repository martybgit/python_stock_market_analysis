...
import pylab   # matplotlib.dates.DateFormatter.date2num() wouldn't work without this module
...
#% pylab inline
#pylab.rcParams['figure.figsize'] = (15, 9)  # Change the size (width, height) of plots
...
def pandas_candlestick_ohlc(dat, stick="day", otherseries=None):
    ...
    candlestick_ohlc(ax, list(
        zip(list(pylab.date2num(plotdat.index.tolist())), plotdat["Open"].tolist(), plotdat["High"].tolist(),
